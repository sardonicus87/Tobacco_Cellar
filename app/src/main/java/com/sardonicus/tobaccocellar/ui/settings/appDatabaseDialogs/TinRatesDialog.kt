...
fun TinRatesDialog(
    ...
    AlertDialog(
            ...
            Box {
                Column(
                    modifier = Modifier
                        ...
                        .padding(top = 16.dp)
                        .alpha(if (debouncedLoading) .38f else 1f),
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            val symbols =
                                remember { DecimalFormatSymbols.getInstance(Locale.getDefault()) }
                            val allowedPattern =
                                remember(symbols.decimalSeparator, symbols.groupingSeparator) {
        ...
        dismissButton = { TextButton({ onDismiss() }, enabled = !debouncedLoading) { Text(stringResource(R.string.cancel)) } },
        confirmButton = {
            TextButton(
                onClick = {
                    onSave(
